...
// import sparkjobs.staydetection._
...
//       // 1 getStays
//       val (getStays) = StayDetection.getStays(dataDF, spark, temporal_threshold_1, spatial_threshold)
...
//       // 2 mapToH3
//       val (passing, stays) = StayDetection.mapToH3(getStays, spark, resolution, temporal_threshold_2, speed_threshold)
//       // passing.show(10)
//       // stays.show(10)
...
//       // 4 mergeH3Region
//       val staysH3Region = StayDetection.mergeH3Region(staysJoined, region_temporal_threshold)
